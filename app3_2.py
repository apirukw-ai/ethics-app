...
# ==========================================
    ...
    with st.form("lab3_2_reflection_form"):
        ...
        r1 = st.text_input("1. คุณธรรมหนึ่งข้อที่ผมคิดว่าสำคัญต่อการเป็นผู้ประกอบวิชาชีพคือ:")
        r2 = st.text_area("2. เพราะอะไร:")
        r3 = st.text_area("3. พฤติกรรมที่ผมสามารถเริ่มฝึกได้ตั้งแต่ตอนเป็นนิสิตคือ:")
        r4 = st.text_area("4. สิ่งที่ผมยังสงสัยเกี่ยวกับการเป็นผู้ประกอบวิชาชีพที่มีจริยธรรมคือ:")
